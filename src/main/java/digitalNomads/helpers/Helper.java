...
public class Helper {
    ...
    public static void waitForElementToBeDisplayed(WebElement element) {
        new WebDriverWait(MainDriver.getDriver(), Duration.ofSeconds(10))
    ...
    public static void waitForElementVisibilityOf(WebElement element){
        WebDriverWait wait = new WebDriverWait(MainDriver.getDriver(),Duration.ofSeconds(10));
    ...
    public static boolean avoidStaleElementClick(WebElement element) {
        ...
        while(attempts < 2) {
            try {
                Actions actions = new Actions(MainDriver.getDriver());
    ...
    public static void jsScrollDownThePage() {
        JavascriptExecutor jse = (JavascriptExecutor)MainDriver.getDriver();
    ...
    public static void jsScrollIntoView(WebElement element){
        ((JavascriptExecutor) MainDriver.getDriver()).executeScript("arguments[0].scrollIntoView(true);",element );
    }
